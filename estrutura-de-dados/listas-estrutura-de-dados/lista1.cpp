...
int reajusteSalario(){
    ...
    if(salario < 1000){
        ...
        cout<<"Reajuste de salário é: "<<salario;
    }
...
int condicaoDePagamento(){
    ...
    switch(codigoDePagamento){
        ...
        break;
        default:
            cout<<"Opção Invalida Selecionada! ";
        break;
    }
}
...
int calculaPorcentagem(int num, int totalDeVotos){
        int resposta;
        resposta = (num * 100) / totalDeVotos;
        return resposta;
}
...
int eleicao(){
    ...
    while(finalizador > 0){
        ...
        default:
            cout<<"Alternativa Inválida selecionada!";
        break;
    }
